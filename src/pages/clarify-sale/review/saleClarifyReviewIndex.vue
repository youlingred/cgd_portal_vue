  ...
  export default {
    ...
    data() {
      return {
        ...
        table: {
          receive: {
            url: this.appConfig.api('inquiry/others/clarification/searchSupReceiverSellClarificationReviewList'),
            pageNo: 1,
            height: 400,
          ...
          reply: {
            url: this.appConfig.api('inquiry/others/clarification/searchSupReceiverSellClarificationReplyList'),
            pageNo: 1,
            height: 400,
            queryParam: function (param) {
              console.log('queryParam:', param)
    ...
    methods: {
        ...
        if (this.selectDatas.length == 1) {
          ...
          this.axios.post(this.appConfig.api('inquiry/others/clarification/beforeReviewCheckInquiry'), {
            ...
            .then((data) => {
              ...
              if (data.isReview == 1) {
                this.$router.push({name: 'saleClarifyReviewEdit', params: {id: this.selectDatas[0].clarificationId}});
              } else {
      ...
      gotoDetail(id) {
        if (this.activeName === 'receive') {
          this.$router.push({name: 'saleClarifyReviewDetailReceive', params: {id: id}});
        } else {
          this.$router.push({name: 'saleClarifyReviewDetailReply', params: {id: id}});
        }
      },
