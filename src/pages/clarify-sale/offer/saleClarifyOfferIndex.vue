    ...
    data() {
      return {
        ...
        table: {
          send: {
            height:400,
            url: this.appConfig.api('inquiry/others/clarification/searchSupPublishSellQuestionList'),
            pageNo: 1,
          ...
          receive: {
            url: this.appConfig.api('inquiry/others/clarification/searchSupReceiverSellClarificationBeforeQuoteList'),
            height: 400,
            pageNo: 1,
            queryParam: function (param) {
              console.log('queryParam:', param)
    ...
    methods: {
      ...
      gotoDetail(id) {
        if (this.activeName === 'send') {
          this.$router.push({name: 'saleClarifyOfferDetailSend', params: {id: id}});
        } else {
